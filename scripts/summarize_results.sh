#!/bin/bash
# summarize_results.sh - Recompute public benchmark summary from published NDJSON results.
#
# This is the canonical benchmark summarizer. It lets readers rebuild the
# paper summary from the
# published row-level results without rerunning the live benchmark harness.
#
# Usage:
#   ./scripts/summarize_results.sh \
#       --input artifacts/live-paper-results.ndjson \
#       --output artifacts/live-paper-summary.json
set -euo pipefail
